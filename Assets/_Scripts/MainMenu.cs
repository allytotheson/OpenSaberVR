...
public class MainMenu : MonoBehaviour
{
    ...
    GameObject _scoreboardOverlayRoot;
    ...
    /// <summary>Called after post-game scoreboard closes and Menu loads; returns to the title screen.</summary>
    public void ReturnToTitleAfterPostGameScoreboard()
    {
        BackToTitleScreen();
    }
